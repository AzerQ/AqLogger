...
public class ServerCreditionals
{
    ...
    /// <summary>
    /// Автогенерируемая строка подключения к серверу Docsvision
    /// </summary>
    public string DocsServerConnectionString
    {
        get => $@"ConnectAddress=http://{ServerName}/DocsVision/StorageServer/StorageServerService.asmx;UserName={AdditionalInfo}/{UserName};Password={Password}";
